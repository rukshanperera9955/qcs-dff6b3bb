      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">
            Accountancy <span className="text-teal">Services</span>
          </h2>
          ...
          {accountancyServices.map((service, index) => (
            ...
            >
              <div className="h-full backdrop-blur-xl bg-card/60 rounded-xl p-6 border border-border/50 shadow-lg shadow-teal/5 hover:shadow-2xl hover:border-teal/50 hover:shadow-teal/15 transition-all duration-500">
                ...
                <h3 className="font-heading font-semibold text-foreground text-lg mb-2 group-hover:text-teal transition-colors">
                  {service.name}
                </h3>
