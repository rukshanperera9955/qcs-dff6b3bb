...
export const mainServices = [
  {
    ...
    description: 'Comprehensive corporate secretarial solutions for company formation, compliance, and governance.',
    color: 'primary',
  },
  {
    id: 'taxation',
    ...
    description: 'Expert tax advisory and compliance services for individuals, partnerships, and companies.',
    color: 'gold',
  },
  {
    id: 'accountancy',
...
export const taxationServicesIndividual: ServiceItem[] = [
  { name: 'TIN Registration for Individual', icon: 'mdi:card-account-details-outline' },
  { name: 'Preparation of Tax Calculation', icon: 'mdi:calculator' },
  { name: 'Submission of IIT Return', icon: 'mdi:file-send-outline' },
  { name: 'VAT Registration & Submission of Return (If having Business)', icon: 'mdi:receipt-text-outline' },
  { name: 'SSCL Registration & Submission of Return (If having Business)', icon: 'mdi:shield-check-outline' },
  { name: 'APIT/PAYE Registration & Submission of Return (If having Business)', icon: 'mdi:account-cash-outline' },
  { name: 'WHT Registration & Submission of Return (If having Business)', icon: 'mdi:bank-transfer-out' },
...
export const taxationServicesPartnership: ServiceItem[] = [
  { name: 'TIN Registration for Partnership', icon: 'mdi:card-account-details-outline' },
  { name: 'Preparation of Tax Calculation for Partnership', icon: 'mdi:calculator' },
  { name: 'Submission of PIT Return', icon: 'mdi:file-send-outline' },
  { name: 'VAT Registration & Submission of Return', icon: 'mdi:receipt-text-outline' },
  { name: 'SSCL Registration & Submission of Return', icon: 'mdi:shield-check-outline' },
  { name: 'APIT/PAYE Registration & Submission of Return', icon: 'mdi:account-cash-outline' },
  { name: 'WHT Registration & Submission of Return', icon: 'mdi:bank-transfer-out' },
  { name: 'Quarterly Payments', icon: 'mdi:calendar-check-outline' },
  { name: 'Obtaining Clearance', icon: 'mdi:check-decagram' },
];

export const taxationServicesCompany: ServiceItem[] = [
  { name: 'TIN Registration for Companies', icon: 'mdi:card-account-details-outline' },
  { name: 'Preparation of Tax Calculation for Companies', icon: 'mdi:calculator' },
